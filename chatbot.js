        ...
        pricing: {
            message: {
                en: 'Choose the plan that fits your goals:<br><br>' +
                    '💎 <strong>5-Year Plan</strong> - $4,949 MXN <small>(save 34%)</small><br>' +
                    '• Only $82 MXN/month<br>' +
                    '• <em>Best long-term value</em><br><br>' +
                    '⭐ <strong>2-Year Plan</strong> - $2,499 MXN <small>(save 17%)</small><br>' +
                    '• Only $104 MXN/month<br>' +
                ...
                es: 'Elige el plan que se ajuste a tus metas:<br><br>' +
                    '💎 <strong>Plan de 5 Años</strong> - $4,949 MXN <small>(ahorra 34%)</small><br>' +
                    '• Solo $82 MXN/mes<br>' +
                    '• <em>Mejor valor a largo plazo</em><br><br>' +
                    '⭐ <strong>Plan de 2 Años</strong> - $2,499 MXN <small>(ahorra 17%)</small><br>' +
                    '• Solo $104 MXN/mes<br>' +
                ...
                pt: 'Escolha o plano que atende aos seus objetivos:<br><br>' +
                    '💎 <strong>Plano de 5 Anos</strong> - $4,949 MXN <small>(economize 34%)</small><br>' +
                    '• Apenas $82 MXN/mês<br>' +
                    '• <em>Melhor valor a longo prazo</em><br><br>' +
                    '⭐ <strong>Plano de 2 Anos</strong> - $2,499 MXN <small>(economize 17%)</small><br>' +
                    '• Apenas $104 MXN/mês<br>' +
        ...
        subscribe: {
            message: {
                en: '🚀 Ready to become fluent? Choose your subscription:<br><br>' +
                    '1. <strong>5-Year Plan</strong> - $4,949 MXN (save 34%)<br>' +
                    '2. <strong>2-Year Plan</strong> - $2,499 MXN (save 17%)',
                es: '🚀 ¿Listo para ser fluido? Elige tu suscripción:<br><br>' +
                    '1. <strong>Plan de 5 Años</strong> - $4,949 MXN (ahorra 34%)<br>' +
                    '2. <strong>Plan de 2 Años</strong> - $2,499 MXN (ahorra 17%)',
                pt: '🚀 Pronto para se tornar fluente? Escolha sua assinatura:<br><br>' +
                    '1. <strong>Plano de 5 Anos</strong> - $4,949 MXN (economize 34%)<br>' +
                    '2. <strong>Plano de 2 Anos</strong> - $2,499 MXN (economize 17%)'
            },
            options: [
                { text: { en: '💳 5-Year ($4,949)', es: '💳 5 Años ($4,949)', pt: '💳 5 Anos ($4,949)' }, next: 'processPayment5Year', emoji: '💳' },
                { text: { en: '💳 2-Year ($2,499)', es: '💳 2 Años ($2,499)', pt: '💳 2 Anos ($2,499)' }, next: 'processPayment2Year', emoji: '💳' },
